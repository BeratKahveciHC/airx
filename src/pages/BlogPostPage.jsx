  ...
  if (loading) {
    return (
      <div style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ width: 32, height: 32, borderRadius: '50%', border: '3px solid #e8f0f9', borderTopColor: '#003C75', animation: 'spin 0.7s linear infinite' }} />
  ...
  return (
    <div style={{ background: '#fff' }}>
      ...
      <style>{`
        ...
        .blog-content hr {
          border: none; border-top: 1px solid #e8f0f9;
          margin: 40px 0;
        }
